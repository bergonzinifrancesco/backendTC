...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AvatarUtente',
            fields=[
                ('img_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondaria', models.CharField(choices=[('veloce', 'Veloce'), ('agile', 'Agile'), ('tecnico', 'Tecnico'), ('fisico', 'Fisico'), ('tattico', 'Tattico'), ('acrobata', 'Acrobata')], max_length=8, null=True)),
                ('terziaria', models.CharField(choices=[('veloce', 'Veloce'), ('agile', 'Agile'), ('tecnico', 'Tecnico'), ('fisico', 'Fisico'), ('tattico', 'Tattico'), ('acrobata', 'Acrobata')], max_length=8, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='InfoAvanzate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternativa', models.CharField(choices=[('POR', 'Portiere'), ('DIF', 'Difensore'), ('CEN', 'Centrocampista'), ('ATT', 'Attaccante'), ('DIF_TER', 'Terzino'), ('CEN_ALA', 'Ala'), ('CEN_TRQ', 'Trequartista'), ('QLS', 'Qualsiasi')], default='QLS', max_length=7, null=True)),
                ('alternativa2', models.CharField(choices=[('POR', 'Portiere'), ('DIF', 'Difensore'), ('CEN', 'Centrocampista'), ('ATT', 'Attaccante'), ('DIF_TER', 'Terzino'), ('CEN_ALA', 'Ala'), ('CEN_TRQ', 'Trequartista'), ('QLS', 'Qualsiasi')], default='QLS', max_length=7, null=True)),
            ],
        ),
    ]
